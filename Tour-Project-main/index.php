        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <div class="content">
                    ...
                    <a href="booking.php?package=Manali Package" class="btn">Explore Now</a>
                </div>
            </div>
            ...
            <div class="box">
                ...
                <div class="content">
                    ...
                    <a href="booking.php?package=Goa Package" class="btn">Explore Now</a>
                </div>
            </div>
            ...
            <div class="box">
                ...
                <div class="content">
                    ...
                    <a href="booking.php?package=Delhi Package" class="btn">Explore Now</a>
                </div>
            </div>
            ...
            <div class="box">
                ...
                <div class="content">
                    ...
                    <a href="booking.php?package=Jaipur Package" class="btn">Explore Now</a>
                </div>
            </div>
            ...
            <div class="box">
                ...
                <div class="content">
                    ...
                    <a href="booking.php?package=Kerala Package" class="btn">Explore Now</a>
                </div>
            </div>
            ...
            <div class="box">
                ...
                <div class="content">
                    ...
                    <a href="booking.php?package=Darjeeling Package" class="btn">Explore Now</a>
                </div>
            </div>
...
<button type="submit">Send</button>
    ...
    <section class="footer">
        ...
        <div class="box-container">
            ...
            <div class="box">
                <h3>contact info</h3>
                <a href="tel:+918115585868"> <i class="fas fa-phone"></i> +91 9873255642 </a>
                <a href="mailto: gandharvsood1234@gmail.com"> <i class="fas fa-envelope"></i> gandharvsood1234@gmail.com </a>
                <a href="#"> <i class="fas fa-map"></i> New Delhi, India - 110059 </a>
            </div>
    
            <div class="box">
                <h3>follow us</h3>
                <a href="https://www.facebook.com/gandharvsood"> <i class="fab fa-facebook-f"></i> facebook </a>
                <a href="https://www.instagram.com/gandharvxs"> <i class="fab fa-instagram"></i> instagram </a>
                <a href="https://www.linkedin.com/in/gandharv-sood/"> <i class="fab fa-linkedin"></i> linkedin </a>
                <a href="https://github.com/GandharvSood"> <i class="fab fa-github"></i> github </a>
            </div>
        </div>
        <div class="credit">created by <span>Gandharv Sood</span> | all rights reserved!</div>
    </section>
    <!-- footer section ends -->
